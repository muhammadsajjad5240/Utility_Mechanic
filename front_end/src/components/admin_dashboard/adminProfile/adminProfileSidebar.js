    ...
    <div>
      ...
      <List>
        {[
          ...
          <Link to={"/mechanic-report?id=" + qurryString.parse(window.location.search).id + "&User=" + qurryString.parse(window.location.search).User}><li style={{textAlign:'left', marginLeft:'25%'}}>Mechanic</li></Link>,
          <Link to={"/service-report?id=" + qurryString.parse(window.location.search).id + "&User=" + qurryString.parse(window.location.search).User}><li style={{textAlign:'left', marginLeft:'25%'}}>Service</li></Link>,
          <Link to={"/customer-report?id=" + qurryString.parse(window.location.search).id + "&User=" + qurryString.parse(window.location.search).User}><li style={{textAlign:'left', marginLeft:'25%'}}>Customer</li></Link>,
         <Link to={"/order-report?id=" + qurryString.parse(window.location.search).id+ "&User=" + qurryString.parse(window.location.search).User}><li style={{textAlign:'left', marginLeft:'25%'}}>Order</li></Link>, 
