  ...
  componentDidMount() {
    ...
    axios.post("/Admin/getAdmin", {
      ...
      .then(responce => {
        ...
        document.getElementById('AdminName').innerHTML = obj.Name;
      ...
      <div id='adminProfile'>
        <Row>
          <Col sm={12} lg={5}>
            <div style={{ width: '400px', height: '350px' }}>
              ...
              <Form onSubmit={this.saveImage}>
                <br />
                <br />
                <center><Button id='btnsave' disabled variant="primary" type="submit">Save</Button></center>
              </Form>
            </div>
            <br />
            <br />
          ...
          <Col className='infocol' sm={{ span: 10, offset: 2 }} lg={{ span: 5, offset: 2 }}>
            ...
            <center> <Link to={'/update-Admin-record?id=' + qurryString.parse(window.location.search).id+ "&User=" + qurryString.parse(window.location.search).User}>
